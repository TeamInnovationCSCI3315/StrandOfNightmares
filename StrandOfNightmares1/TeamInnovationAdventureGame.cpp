...
int main()
{
	...
	*/
	...
	Locations WindingPath("Winding Path", "Winding Path Description", "", "Hilly Fields", "","","","");
	...
	Locations CastleThroneRoom("Castle Throne Room", "Castle Throne Room Description+Boss", "", "", "", "", "", "");
